...
public static class Translations
{
    ...
    private static readonly Dictionary<string, (string En, string Vi)> _map = new()
    {
        ...
        ["mentor.advisor.summary"] = ("Advisor in applied psychology, personal development, communication skills, and mental well-being for students.", "Cố vấn về tâm lý học ứng dụng, phát triển cá nhân, kỹ năng giao tiếp và sức khỏe tinh thần cho học sinh, sinh viên."),
