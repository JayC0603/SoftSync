...
public static class Translations
{
    ...
    private static readonly Dictionary<string, (string En, string Vi)> _map = new()
    {
        ...
        ["mentor.main.role"] = ("Lead Project Mentor", "Mentor Chính Dự án"),
        ...
        ["mentor.main.summary"] = ("Lead Mentor guiding SoftSync Space in soft-skills education, inclusive learning, mental well-being, and community development.", "Mentor chính đồng hành cùng SoftSync Space về giáo dục kỹ năng mềm, học tập hòa nhập, sức khỏe tinh thần và phát triển cộng đồng."),
        ...
        ["mentor.main.highlight3"] = ("Expertise in soft skills, social work, and inclusive education", "Chuyên môn về kỹ năng mềm, công tác xã hội và giáo dục hòa nhập"),
        ["mentor.main.highlight4"] = ("Experience in mental-health, healthcare, and community-support consulting", "Kinh nghiệm tư vấn về sức khỏe tinh thần, chăm sóc sức khỏe và hỗ trợ cộng đồng"),
        ["mentor.main.highlight5"] = ("Works with domestic and international organizations supporting people with disabilities and community development", "Đồng hành cùng các tổ chức trong và ngoài nước về hỗ trợ người khuyết tật và phát triển cộng đồng"),
        ["mentor.main.about"] = ("About", "Giới thiệu"),
        ["mentor.main.bio1"] = ("M.A. Nguyễn Thụy Tố Trâm is the Lead Mentor of SoftSync Space, accompanying the team throughout its research, design, and platform development. As a Soft Skills Lecturer at FPT University – Can Tho Campus, she provides professional guidance on skill development, user experience, and human-centered learning models.", "Th.S. Nguyễn Thụy Tố Trâm là Mentor chính của dự án SoftSync Space, đồng hành cùng nhóm trong quá trình nghiên cứu, xây dựng và phát triển nền tảng. Với vai trò là Giảng viên Bộ môn Kỹ năng mềm tại Trường Đại học FPT – Phân hiệu Cần Thơ, cô mang đến những định hướng chuyên môn về phát triển kỹ năng, trải nghiệm người dùng và xây dựng mô hình học tập lấy con người làm trung tâm."),
        ["mentor.main.bio2"] = ("Alongside teaching, she has many years of experience in social work, mental-health consulting, inclusive education, and support for people with disabilities. She has collaborated with domestic and international organizations including the Flinders University Student with Disabilities Association and AAT Center – Can Tho Women's Union. This practical experience helps SoftSync Space follow Universal Design principles and create a safe, equitable, and welcoming learning environment.", "Bên cạnh hoạt động giảng dạy, cô có nhiều năm kinh nghiệm trong lĩnh vực công tác xã hội, tư vấn sức khỏe tinh thần, giáo dục hòa nhập và hỗ trợ người khuyết tật, từng cộng tác với nhiều tổ chức trong nước và quốc tế như Flinders University Student with Disabilities Association, AAT Center – Hội Liên hiệp Phụ nữ TP. Cần Thơ, cùng các tổ chức hoạt động vì cộng đồng. Những kinh nghiệm thực tiễn này giúp SoftSync Space định hướng phát triển theo tiêu chí tiếp cận toàn diện (Universal Design), đảm bảo nền tảng không chỉ ứng dụng công nghệ AI hiệu quả mà còn tạo ra một môi trường học tập an toàn, bình đẳng và thân thiện với mọi người dùng."),
        ...
        ["mentor.main.specialty.community"] = ("Community support", "Hỗ trợ cộng đồng"),
        ["mentor.main.specialty.inclusion"] = ("Inclusive education", "Giáo dục hòa nhập"),
