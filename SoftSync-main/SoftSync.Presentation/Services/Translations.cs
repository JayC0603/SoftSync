...
public static class Translations
{
    ...
    private static readonly Dictionary<string, (string En, string Vi)> _map = new()
    {
        ...
        ["mentor.advisor.xuan.position"] = ("Soft Skills Lecturer", "Giảng viên Bộ môn Kỹ năng mềm"),
        ["mentor.advisor.xuan.summary"] = ("Soft-skills training expert with more than 17 years of experience, advising on educational technology and practical learner development.", "Chuyên gia đào tạo kỹ năng mềm với hơn 17 năm kinh nghiệm, cố vấn về công nghệ giáo dục và hành trình phát triển thực tiễn của người học."),
        ["mentor.advisor.xuan.highlight1"] = ("Soft Skills Lecturer", "Giảng viên Bộ môn Kỹ năng mềm"),
        ["mentor.advisor.xuan.highlight2"] = ("Soft-skills training expert with more than 17 years of experience", "Chuyên gia đào tạo kỹ năng mềm với hơn 17 năm kinh nghiệm"),
